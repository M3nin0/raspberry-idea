...
Junto ao pandas, na etapa de PGD é possível aplicar o SciPy, esta que é uma biblioteca com muitas funcionalidades para a computação numérico-científica. Com esta biblioteca, que também possuí versões para arquiteturas ARM64, é possível aplicar diferentes conjuntos de interpolações, em especial a PCHIP, módulo já implementado e disponível para uso na biblioteca. Ao utilizar o SciPy, técnicas de análise espectral como o *Power Spectral Density* (PSD) podem ser aplicados, uma vez que a biblioteca disponibiliza os algoritmos de Transformada Rápida de Fourier (FFT) e outros auxiliares.
